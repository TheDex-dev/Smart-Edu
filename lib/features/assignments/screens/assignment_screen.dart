...
class _AssignmentScreenState extends State<AssignmentScreen>
  ...
  final List<String> _filterOptions = MockData.assignmentFilters;
  ...
  Future<void> _addNewAssignment(Map<String, dynamic> assignmentData) async {
    try {
      final assignment = Assignment.fromMap(assignmentData);
  ...
  Future<void> _updateAssignment(
    ...
    try {
      ...
      final assignment = Assignment.fromMap(updatedAssignment..['id'] = assignmentId);
      await FirebaseService.updateAssignment(assignmentId, assignment);
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
